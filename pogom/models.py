...
def send_email(pokemon_name, id, latitude,longitude, expiry_time):
    ...
    co_msg = u'{} Id: {} till {}'.format(pokemon_name,id,expiry_time)
    command = u"echo http://maps.google.com/maps?q={},{} | mail -s \"{}\" maverick2202@hotmail.com ".format(latitude, longitude, co_msg)

    EMAIL_FROM = "maverick2202@yahoo.com"
    EMAIL_TO = "maverick2202@hotmail.com"
    PWD = "Ar@17623"

    msg = MIMEText(co_msg + " @ http://maps.google.com/maps?q={},{}".format(latitude,longitude) )
    msg['Subject'] = co_msg
    msg['From'] = EMAIL_FROM 
    msg['To'] = EMAIL_TO
